...
export const MarkPaymentModal: React.FC<Props> = ({
  ...
  const paymentMethods: { id: PaymentMethod; name: string; hasLink: boolean; comingSoon?: boolean }[] = [
    ...
    { id: 'zelle', name: 'Zelle', hasLink: false, comingSoon: true },
    { id: 'apple_pay', name: 'Apple Pay', hasLink: false, comingSoon: true },
    { id: 'google_pay', name: 'Google Pay', hasLink: true, comingSoon: true },
    { id: 'stripe', name: 'Tarjeta (Stripe)', hasLink: false, comingSoon: true },
    { id: 'card', name: 'Tarjeta', hasLink: false, comingSoon: true },
